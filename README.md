...
## 2.1. General Purpose Input Output for a Processing Unit

### 2.1.1. Functionality

| Core                           | Module description                              |
| ------------------------------ | ----------------------------------------------- |
| `mpsoc_ahb3_peripheral_bridge` | APB4 to AHB3 Bridge                             |
| `...mpsoc_apb_gpio`            | General Purpose Input Output for AMBA3 AHB-Lite |
...
## 2.2. General Purpose Input Output for a System on Chip
...
## 2.3. General Purpose Input Output for a Multi-Processor System on Chip
